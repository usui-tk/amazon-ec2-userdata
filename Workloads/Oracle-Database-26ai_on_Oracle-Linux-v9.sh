...
################################################################################
################################################################################
#                   Building Oracle AI Database Server (26ai)                     #
################################################################################
################################################################################
# [Official Document]
...
#
# [Reference]
# https://oracle-base.com/articles/26/oracle-ai-db-26-free-rpm-installation-on-oracle-linux-9
...
#-------------------------------------------------------------------------------
# Oracle AI Database Server installation [Oracle AI Database 26ai]
#-------------------------------------------------------------------------------

cd /tmp

# Download Oracle AI Database Server (26ai) RPM Package
curl -LO -H "Cookie: oraclelicense=accept-securebackup-cookie" "https://download.oracle.com/otn-pub/otn_software/db-free/oracle-ai-database-free-26ai-23.26.1-1.el9.x86_64.rpm"

# Package Install Oracle Database Server (from Local File)
dnf localinstall -y "/tmp/oracle-ai-database-free-26ai-23.26.1-1.el9.x86_64.rpm"
