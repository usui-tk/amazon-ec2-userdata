...
# Parameter Settings
CWAgentConfig="https://raw.githubusercontent.com/usui-tk/amazon-ec2-userdata/main/Config_AmazonCloudWatchAgent/AmazonCloudWatchAgent_Ubuntu-18.04-LTS-HVM.json"
