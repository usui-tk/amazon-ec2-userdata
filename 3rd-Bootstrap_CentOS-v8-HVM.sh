...
# DNF-Module Enable Python 3.8 Runtime (from CentOS Community Repository)
# dnf module list | grep python3
# dnf install -y @python38
# dnf module list | grep python3

# Package Install Python 3.8 Runtime (from CentOS Community Repository)
...
sed -i "/pool 2.pool.ntp.org iburst/a server 169.254.169.123 prefer iburst" /etc/chrony.conf
