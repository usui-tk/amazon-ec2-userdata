...
# Parameter Settings
CWAgentConfig="https://raw.githubusercontent.com/usui-tk/amazon-ec2-userdata/refs/heads/main/Config_AmazonCloudWatchAgent/AmazonCloudWatchAgent_AlmaLinux-v10-HVM.json"
...
#    https://aws.amazon.com/marketplace/pp/prodview-tommf6drdxv4w
#
...
# https://access.redhat.com/documentation/en-us/red_hat_enterprise_linux/10/html-single/managing_systems_using_the_rhel_9_web_console/index
#-------------------------------------------------------------------------------
...
# Package Install Python 3.12 Runtime (from AlmaLinux Community Repository)
...
# Package Install AWS-CLI v2 packages (from AlmaLinux Community Repository)
