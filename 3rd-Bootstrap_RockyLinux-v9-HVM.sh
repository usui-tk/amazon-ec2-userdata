...
dnf --enablerepo="epel" install -y aria2 atop bash-color-prompt byobu collectd collectd-utils colordiff colorized-logs dateutils fping glances htop iftop inotify-tools inxi ipv6calc jc lsb_release moreutils moreutils-parallel ncdu nkf nload screen ssh-audit stressapptest unicornscan wdiff yamllint
