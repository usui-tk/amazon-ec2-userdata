...
# Parameter Settings
CWAgentConfig="https://raw.githubusercontent.com/usui-tk/amazon-ec2-userdata/refs/heads/main/Config_AmazonCloudWatchAgent/AmazonCloudWatchAgent_RockyLinux-v10-HVM.json"
...
#  https://download.rockylinux.org/pub/rocky/10/BaseOS/x86_64/
#-------------------------------------------------------------------------------
...
# Package Install Python 3.12 Runtime (from Rocky Linux Repository)
...
dnf --enablerepo="epel" install -y 7zip-standalone-all aria2 atop collectd collectd-utils colordiff colorized-logs crudini fping gh htop iftop inotify-tools ipv6calc ipv6toolkit java-latest-openjdk jc lsb_release moreutils moreutils-parallel ncdu nkf nload rpmconf screen ssh-audit ssldump sslscan stressapptest uv vnstat wdiff yamllint yq
