...
dnf --enablerepo="epel" install -y bash-color-prompt colordiff fping htop iftop ipv6calc jc lsb_release moreutils moreutils-parallel ncdu screen ssh-audit stressapptest wdiff
