...
# Parameter Settings
CWAgentConfig="https://raw.githubusercontent.com/usui-tk/amazon-ec2-userdata/master/Config_AmazonCloudWatchAgent/AmazonCloudWatchAgent_CentOS-v10-HVM.json"
...
#-------------------------------------------------------------------------------
# Yum Repositories (CentOS Stream release 10)
#  http://mirror.stream.centos.org/10-stream/
#-------------------------------------------------------------------------------
...
# dnf install -y centos-stream-release centos-release-cloud centos-release-hyperscale
