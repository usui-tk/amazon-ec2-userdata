...
if ($RoleName) {
	...
	if ($SSMAccessibleFlags -eq $True) {
		...
		Get-EC2Image -Region $Region -ImageId ((Get-SSMParameterValue -Region $Region -Name "/aws/service/ami-windows-latest/Windows_Server-2012-R2_RTM-English-64Bit-Base").Parameters[0].Value) | ConvertTo-Json -Depth 100 | Out-File "$LOGS_DIR\AMI-Information_Get-EC2Image_Windows_Server-2012-R2_RTM-English-64Bit-Base.txt" -Append -Force
...
if ($WindowsOSVersion -eq "6.1") {
	...
	Get-WebContentToFile -Uri 'https://raw.githubusercontent.com/usui-tk/amazon-ec2-userdata/refs/heads/main/Config_AmazonCloudWatchAgent/AmazonCloudWatchAgent_WindowsServer-2008R2.json' -OutFile "$TOOL_DIR\AmazonCloudWatchAgent-Config.json"
}
elseif ($WindowsOSVersion -eq "6.2") {
	Write-Log ("# Save Amazon CloudWatch Agent Config Files [Windows Server 2012] : Windows OS Version : " + $WindowsOSVersion)
	Get-WebContentToFile -Uri 'https://raw.githubusercontent.com/usui-tk/amazon-ec2-userdata/refs/heads/main/Config_AmazonCloudWatchAgent/AmazonCloudWatchAgent_WindowsServer-2012.json' -OutFile "$TOOL_DIR\AmazonCloudWatchAgent-Config.json"
}
elseif ($WindowsOSVersion -eq "6.3") {
	Write-Log ("# Save Amazon CloudWatch Agent Config Files [Windows Server 2012 R2] : Windows OS Version : " + $WindowsOSVersion)
	Get-WebContentToFile -Uri 'https://raw.githubusercontent.com/usui-tk/amazon-ec2-userdata/refs/heads/main/Config_AmazonCloudWatchAgent/AmazonCloudWatchAgent_WindowsServer-2012R2.json' -OutFile "$TOOL_DIR\AmazonCloudWatchAgent-Config.json"
}
elseif ($WindowsOSVersion -eq "10.0") {
	switch ($WindowsOSName) {
		'Windows Server 2016' {
			Write-Log ("# Save Amazon CloudWatch Agent Config Files [Windows Server 2016] : Windows OS Version : " + $WindowsOSVersion)
			Get-WebContentToFile -Uri 'https://raw.githubusercontent.com/usui-tk/amazon-ec2-userdata/refs/heads/main/Config_AmazonCloudWatchAgent/AmazonCloudWatchAgent_WindowsServer-2016.json' -OutFile "$TOOL_DIR\AmazonCloudWatchAgent-Config.json"
		}
		'Windows Server 2019' {
			Write-Log ("# Save Amazon CloudWatch Agent Config Files [Windows Server 2019] : Windows OS Version : " + $WindowsOSVersion)
			Get-WebContentToFile -Uri 'https://raw.githubusercontent.com/usui-tk/amazon-ec2-userdata/refs/heads/main/Config_AmazonCloudWatchAgent/AmazonCloudWatchAgent_WindowsServer-2019.json' -OutFile "$TOOL_DIR\AmazonCloudWatchAgent-Config.json"
		}
		'Windows Server 2022' {
			Write-Log ("# Save Amazon CloudWatch Agent Config Files [Windows Server 2022] : Windows OS Version : " + $WindowsOSVersion)
			Get-WebContentToFile -Uri 'https://raw.githubusercontent.com/usui-tk/amazon-ec2-userdata/refs/heads/main/Config_AmazonCloudWatchAgent/AmazonCloudWatchAgent_WindowsServer-2022.json' -OutFile "$TOOL_DIR\AmazonCloudWatchAgent-Config.json"
		}
		default {
			Write-Log ("# Save Amazon CloudWatch Agent Config Files [Windows Server 2022] : Windows OS Version : " + $WindowsOSVersion)
			Get-WebContentToFile -Uri 'https://raw.githubusercontent.com/usui-tk/amazon-ec2-userdata/refs/heads/main/Config_AmazonCloudWatchAgent/AmazonCloudWatchAgent_WindowsServer-2022.json' -OutFile "$TOOL_DIR\AmazonCloudWatchAgent-Config.json"
