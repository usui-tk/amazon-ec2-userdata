...
#-------------------------------------------------------------------------------
# BANNER CONFIGURATION - CentOS (motd)
#-------------------------------------------------------------------------------
...
chown root:centos  ${BASTION_LOGFILE}
chown root:centos  ${BASTION_LOGFILE_SHADOW}
...
#-------------------------------------------------------------------------------
# AUTOMATICALLY UPDATE CONFIGURATION - CentOS (yum update - security)
#-------------------------------------------------------------------------------
...
log_group_name = BastionServer-Linux-LogGroupName
log_stream_name = {instance_id}-{hostname}-{ip_address}-LogFile-chrony-statistics.log
datetime_format = %b %d %H:%M:%S
time_zone = LOCAL
