...
Set-Variable -Name DecisionScript -Option Constant -Scope Script -Value "https://raw.githubusercontent.com/usui-tk/amazon-ec2-userdata/refs/heads/main/2nd-Decision_WindowsServer-Version.ps1"
