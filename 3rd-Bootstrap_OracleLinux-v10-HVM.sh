...
dnf --enablerepo="ol10_u0_developer_EPEL" install -y 7zip-standalone-all aria2 colordiff colorized-logs crudini fping fping gh htop iftop inotify-tools ipv6calc ipv6toolkit jc lsb_release moreutils moreutils-parallel ncdu nkf nload rpmconf rpmconf screen ssh-audit ssldump stressapptest wdiff yq

# dnf --enablerepo="ol10_u0_developer_EPEL" install -y 7zip-standalone-all aria2 atop byobu collectd collectd-utils colordiff colorized-logs crudini dateutils fping fping gh glances htop iftop inotify-tools inxi ipv6calc ipv6toolkit jc lsb_release moreutils moreutils-parallel ncdu nkf nload rpmconf rpmconf screen ssh-audit ssldump stressapptest unicornscan wdiff yamllint yq
